#!/usr/bin/env python3
"""Compute fail-closed, deterministic scope signals for multi-agent-code-review-sub-skills."""
...
def repo_root() -> Path:
    ...
    directory. multi-agent-code-review-sub-skills can run from a subdirectory (``git diff`` still
