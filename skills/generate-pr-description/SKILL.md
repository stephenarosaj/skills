...
Use this skill whenever asked to write a description or summary for a GitHub pull request ("PR") or branch diff.
...
3. **Draft Description & Output**:
   ...
   * Suppress conversational preamble or postscript commentary. Output a clean 1-line status banner (e.g. `📄 PR description generated for branch: <branch-name>`) followed directly by the raw markdown description in the chat response.
