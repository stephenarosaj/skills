...
If the command completes with a non-zero exit code or with a message like "no pull requests found", then report that you were unable to determine the PR number.
