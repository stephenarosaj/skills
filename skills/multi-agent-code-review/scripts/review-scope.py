#!/usr/bin/env python3
"""Compute fail-closed, deterministic scope signals for multi-agent-code-review."""
...
def repo_root() -> Path:
    ...
    directory. multi-agent-code-review can run from a subdirectory (``git diff`` still
